...
def return_text_fellowship(file_path, start_line=None):
    ...
    for line in last_lines:
        if '[To Fellowship]' in line or 'You have joined the chat room for your Fellowship, Fellowship chat is now available.' in line:
            continue
...
def translate_messages_fellowship(lang, messages, processed_timestamps):
    playername = ''
    text = ''
